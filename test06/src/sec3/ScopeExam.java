...
public class ScopeExam {
	...
	static int b = 100;		//클래스 변수 : 클래스 전체에서 인지되먀, 특정 메소드(함수) 내에서도 인지함 = global Scope
	public static void main(String[] args) {
		int a = 20; //지역 변수 : 특정 메소드(함수)내에서 선언되어 활용되는 변수로서 함수 블록을 벗어나면, 인지할 수 없음. = Local Scope
		System.out.println("지역변수 a="+a);
		run();
		run(30);
	}
	public static void run() {
		// System.out.println("전역 변수 a="+a); //클래스 변수가 아니라 인식이 안됌
