...
public class StringExam1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("n의 글자 위치(인덱스)를 n 에 저장 : "+n);
		int n2 = data.trim().lastIndexOf('n');   	//마지막 n의 글자 위치(인덱스)를 n에 저장
		System.out.println("n의 글자 위치(인덱스)를 n 에 저장 : "+n2);
		...
		String sub1 = data.substring(22,30); //※공백을 제거하고, 20번째 글자 부터 27번째만 추출 sub1에 저장
		System.out.println("공백을 제거하고, 20번째 글자 부터 27번째만 추출 sub1에 저장 : "+sub1);
		...
		byte[] girl = data.getBytes(); //※문자열을 girl 문자(byte)배열로 변환하여 저장
