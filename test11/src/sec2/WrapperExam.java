...
public class WrapperExam {
	public static void main(String[] args) {
		int a = 10; 	//기본 타입 선언
		Integer b = a;	//b는 참조형 타입 선언(참조형에 기본형 데이터 대입 : Wrapping, Boxing)
		int c = b; //c는 (기본형에 참조형 데이터 대입 : UnWrap, UnBoxing)
		...
		System.out.println("문자열 3.14를 Double(실수) 타입의 3.14으로 변경 =>"+Double.valueOf("e"));
	}
