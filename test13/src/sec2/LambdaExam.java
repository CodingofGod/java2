...
//함수적 인터페이스는 @FuntionalInterface 로 정의 
...
public class LambdaExam { 
	public static void main(String[] args) {
		...
		*/
		System.out.println("람다식1 - 매개변수X, 반환 X");
		Lambda1 f1 = () -> {
			int x = 100, y = 200;
			System.out.println(x+y);
		};
		...
		System.out.println("람다식2 - 매개변수O, 반환 X");
		Lambda2 f2 = (int x, int y) -> {
			System.out.println(x+y);
		};
		f2.method2(100, 200);
		
		System.out.println("람다식3 - 매개변수X, 반환 O");
		Lambda3 f3 = () -> {
			int x=100, y=200;
			return x+y;
		};
		System.out.println(f3.method3());
		System.out.println("람다식4 - 매개변수O, 반환 O");
