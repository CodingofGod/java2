...
public class ArrayListExam {
	public static void main(String[] args) {
		...
		for(int i=1;i<10;i++) {
			Member mem = new Member(i,"kang"+i, "abcd"+i+i, "강"+i, 0);
			memList.add(mem);
		}
		Member mem2 = new Member(11,"kang", "abcd1004", "오주형", 0);
		memList.add(mem2);
		...
		memList.remove(3); 	//인데스가 3인 Member 인스턴스가 제거
		
		Member tmp1 = new Member(11,"kang", "abcd1004", "오주형", 0);
